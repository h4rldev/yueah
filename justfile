...
link_flags := '-ljansson -lh2o -lssl -lcrypto -lz -luv -lm -lbrotlidec -lbrotlienc -lbsd -flto -std=c99 -fsanitize=address -ggdb -static-libasan'
debug_compile_flags := '-ggdb -fsanitize=address'
